...
//note to self: voidsetup allows the if(mousePressed) function to work since it repeatedly checks if the mouse is pressed
...
fill(#03fcde);
if(mousePressed)
text("IT WORKED FIRST TIME",0,470);
